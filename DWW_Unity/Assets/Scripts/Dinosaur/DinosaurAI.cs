...
public class DinosaurAI : MonoBehaviour
{
            ...
            case State.Walk:
                {
                    ...
                    else if (_distanceToNewPos < 1.0f)
                    {
                        _newPos = Vector3.zero;
                        _randomWayPoint = Vector3.zero;
                        agent.ResetPath();
    ...
    private void RunAway()
    {
        ...
        {
            _randomRunPoint = Random.insideUnitSphere * 20;
            _randomRunPoint.y = 0;
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireSphere(_pathZone, 20.0f);
